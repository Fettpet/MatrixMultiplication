...
static inline void mat_mult_non_opt( float *A, float *B, float *C, const unsigned int dim);
static inline void mat_mult_transpose( float *A, float *B, float *C, const unsigned int dim);
static inline void mat_mult_unroll_transpose( float *A, float *B, float *C, const unsigned int dim);
static inline void mat_mult_blocking( float *A, float *B, float *C, const unsigned int dim);
 ...
 */
static inline void mat_mult_transpose( float *restrict A, float *B, float *C, const unsigned int dim){
    transpose_mat(B, dim);
    float *restrict b = B;
    uint32_t j, i;
    uint32_t idim, jdim;
...
/*
static inline void mat_mult_avx2(float *A, float *B, float *C, const unsigned int dim){
    transpose_mat(B, dim);
    __m256d *vecA, *vecB;
        for ( uint32_t i = 0; i < dim; i++ )
        {
