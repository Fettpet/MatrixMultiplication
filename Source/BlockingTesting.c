...
static inline void mat_mult_blocking2( double *A, double *B, double *C, const unsigned int dim);
static inline void mat_mult_blocking4( double *A, double *B, double *C, const unsigned int dim);
static inline void mat_mult_blocking8( double *A, double *B, double *C, const unsigned int dim);
static inline void mat_mult_blocking16( double *A, double *B, double *C, const unsigned int dim);
static inline void mat_mult_blocking32( double *A, double *B, double *C, const unsigned int dim);
